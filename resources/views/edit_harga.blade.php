...
<div class="container-fluid">
  <h2>Edit Harga</h2> <br>
     <div class="card-header  text-center" >
      ...
      <form action="/updateharga" method="post">
        @csrf
      <table>          
          <input type="hidden" name="id" value="{{$data->id_barang}}">
        
          <tr>
            <td><span>Harga Awal </span></td>
            <td><input type="text" id="txt1" style="width:265px; height:30px;" name="hargaawal" ><br></td>
          </tr>
          <tr>
            <td><span>Harga Sekarang </span></td>
            <td><input type="text" id="txt2" style="width:265px; height:30px;" name="hargasekarang" ></td> 
          </tr>
          
          <tr>
            <td></td>
            <td ><button class="btn btn-primary btn-block"> Save</button></td>
