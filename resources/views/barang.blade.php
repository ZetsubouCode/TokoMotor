          ...
          <div class="card-body"> 
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><input type="text" style="width:265px; height:30px;" name="merk" Required></td>
                </tr>
               ...
               <!--  <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" id="txt1" style="width:265px; height:30px;" name="hargajual" onkeyup="sum();" Required><br></td>
                </tr>
                <tr>
...
<div class="container-fluid">
    <!-- <a  href="addproduct" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#zexampleModal" style="float: left;">Add Produk</a>  -->
  ...
  Add Product
   ...
   <table class="table table-bordered text-center " id="resultTable" data-responsive="table">
    ...
    <tr>      
      ...
      <td>
        <a  href="/editharga/{{$a->id_barang}}"><button  > Edit Harga</button></a><br>
        <a  href="/editstok/{{$a->id_barang}}"><button style="background-color: yellow;"> Edit Stok</button></a><br>
        <a  href="/hapusproduct/{{$a->id_barang}}" ><button style="background-color: red;"> Hapus</button></a>
      </td>
    </tr>
      @endforeach
  </table>
