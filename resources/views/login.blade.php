...
<head>
  ...
  <link href="{{asset ('test/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
            ...
            <div align="center " class="row">
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h3 text-gray-900 mb-4"><b>Antok Sparepart</b></h1>
                  </div>
                  <form class="user" method="post" action="/cek_login">
                    @csrf
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email" name="email">
                    </div>
                    <div class="form-group">
