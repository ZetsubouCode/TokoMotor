...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="barang_kasir">
  ...
  <!--awal  -->
<form>
     <input type="text" name="" placeholder="pilih product">
  ...
  <thead>
    ...
    <tr style="background-color: grey;">
      ...
      <td></td>
      <td>
        <a  href="#" ><button style="background-color: red;"> Hapus</button></a>
      </td>
    </tr>
    <tr>
      <th> </th>
      ...
      <td>Total Sale: </td>
  <tr>
    <td colspan="5"><strong style="font-size: 12px; color: #222222;"><p class="lead">Grand Total :</p></strong></td>
    <td class="bg-warning text-white" colspan="1"><strong style="font-size: 12px; color: #222222;"><p class="lead">
    </tr>

    <tr>
      <td colspan="6"><button class="btn btn-primary btn-block"> Bayar</button></td> 
    </tr>
      </thead>
   </table>
